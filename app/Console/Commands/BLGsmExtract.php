            ...
            if($pmDB){
                ...
                // print_r($res);exit;
                  if($res){
                      ...
                      if($res[0]['kpi3']==0){
                          $B_S_GSM->data_traffic_pdch=0;
                      }else{
                         $B_S_GSM->data_traffic_pdch=$res[0]['kpi1']/$res[0]['kpi3'];
